...
namespace App\Models {
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\CampaignMetric> $Metrics
     * @property-read int|null $Metrics_count
     * @method static \Illuminate\Database\Eloquent\Builder<Campaign>|Campaign whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Campaign>|Campaign whereBrandId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Campaign>|Campaign whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Campaign>|Campaign whereTanggal($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<CampaignMetric>|CampaignMetric newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CampaignMetric>|CampaignMetric query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class CampaignMetric extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereGoogleAvatar($value)
